...
const WelcomePage = () => {
    ...
    return (
        <div id="welcome" className="min-h-screen grid content-center animate__fadeIn mt-20">
            <div>
                <p className="text-5xl flex justify-center mb-3">Welcome</p>
                <p className="text-2xl flex justify-center">
                    <span className="p-1">
                        I'm Michelle, a front-end developer building modern web applications with
